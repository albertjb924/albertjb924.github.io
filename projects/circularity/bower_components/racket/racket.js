    ...
    var racket = {
        physikz: {
            addRandomVelocity: function (body, area, multiplierX, multiplierY) {
                multiplierX = (multiplierX) ? multiplierX : Math.ceil(Math.random() * 5);
                multiplierY = (multiplierY) ? multiplierY : Math.ceil(Math.random() * 5);
            ...
            updateRadialPositionInArea: function (body, area) {
                ...
                var w  = area.width + radius * 10;
                var h = area.height + radius * 10;
