...
(function (window) {
    ...
    opspark.cannon.factory = function (game) {
        ...
        let create = {
           ...
           onTop1: function(position, delay) {
               if (position < 0 || position > game.world.width) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
               var cannon = game.cannon.create(position, 20, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.scale.y = -1;
               let projectile = createProjectile(cannon.x, cannon.y);
               let tween = game.add.tween(projectile).to( { y: game.world.height + projectile.height }, 2000, null, true, delay || 0, -1);
           ...
           ,
           onLeft1: function (position, delay){
               ...
               let cannon = game.cannon.create(20, position, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.angle = 0;
               let projectile = game.projectile.create(cannon.x, cannon.y, assetKeyProjectile);
               projectile.anchor.setTo(0.5, 0.5);
           ...
           onLeft2: function (position, delay){
               if (position < 0 || position > game.world.height) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
               let cannon = game.cannon.create(40, position, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.angle = 0;
               let projectile = game.projectile.create(cannon.x, cannon.y, assetKeyProjectile);
               projectile.anchor.setTo(0.5, 0.5);
           ...
           onLeft3: function (position, delay){
               if (position < 0 || position > game.world.height) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
               let cannon = game.cannon.create(60, position, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.angle = 0;
               let projectile = game.projectile.create(cannon.x, cannon.y, assetKeyProjectile);
               projectile.anchor.setTo(0.5, 0.5);
            ...
            onLeft4: function (position, delay){
               if (position < 0 || position > game.world.height) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
               let cannon = game.cannon.create(80, position, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.angle = 0;
               let projectile = game.projectile.create(cannon.x, cannon.y, assetKeyProjectile);
               projectile.anchor.setTo(0.5, 0.5);
            ...
            onLeft5: function (position, delay){
               if (position < 0 || position > game.world.height) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
               let cannon = game.cannon.create(100, position, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.angle = 0;
               let projectile = game.projectile.create(cannon.x, cannon.y, assetKeyProjectile);
               projectile.anchor.setTo(0.5, 0.5);
           ...
           onRight1: function (position, delay){
               if (position < 0 || position > game.world.height) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
               let cannon = game.cannon.create(game.world.width - 800, position, assetKeyCannon);
               cannon.anchor.setTo(0.5, 0.5);
               cannon.angle = -90;
               let projectile = game.projectile.create(cannon.x, cannon.y, assetKeyProjectile);
               projectile.anchor.setTo(0.5, 0.5);
           ...
           onRight2: function (position, delay){
               if (position < 0 || position > game.world.height) { throw new Error(`You are trying to place a cannon off the stage at ${position}, this is not allowed!`); }
